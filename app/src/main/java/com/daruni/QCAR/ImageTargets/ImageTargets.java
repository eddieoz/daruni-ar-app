...
import com.daruni.QCAR.ImageTargets.ui.SampleAppMenu.SampleAppMenu;
import com.daruni.QCAR.ImageTargets.ui.SampleAppMenu.SampleAppMenuGroup;
import com.daruni.QCAR.ImageTargets.ui.SampleAppMenu.SampleAppMenuInterface;
...
public class ImageTargets extends Activity implements SampleAppMenuInterface
{
    ...
    {
    	mTextures.add(Texture.loadTextureFromApk("mbcr1953lqc_texture.png",
                getAssets()));
    ...
    /** Native method for starting / stopping Descriptions */
    private native boolean startDesc();
    
    private native boolean stopDesc();
        ...
        GestureDetector.SimpleOnGestureListener
    {
        ...
        public boolean onDoubleTap(MotionEvent e){
        	...
        	if ( lastProduct == MBCR1953LQC_DATASET_ID ){ 
        		Uri uriUrl = Uri.parse("http://www.terceiraidade.com/cadeira-de-rodas-aluminio-mbcr1953lqc-mobil-saude.html?utm_source=daruni_app&utm_medium=app&utm_content=mbcr1953lqc&utm_campaign=Daruni%20App");
            ...
            if ( lastProduct == MLM007_DATASET_ID ){
                Uri uriUrl = Uri.parse("http://www.terceiraidade.com/bengala-com-assento.html?utm_source=daruni_app&utm_medium=app&utm_content=mlm007&utm_campaign=Daruni%20App");
                Intent launchBrowser = new Intent(Intent.ACTION_VIEW, uriUrl);
                startActivity(launchBrowser);
    ...
    private void setSampleAppMenuSettings()
    {
        ...
        group.addSelectionItem(getString(R.string.menu_desc),
                CMD_DESC, false);
        ...
        switch (command)
        {
            ...
            case CMD_DESC:
            	if (mDesc)
                {
                    ...
                    if (!result)
                    {
                        showToast("Failed to stop description");
                        DebugLog
                            .LOGE("Failed to stop description");
                    }
                } else
                {
                    result = startDesc();
                    if (!result)
                    {
                        showToast("Failed to start description");
                        DebugLog
                            .LOGE("Failed to start description");
                    }
                }
            ...
            case CMD_DATASET_MBA012_DATASET:
                ...
                switchDatasetAsap(MBA012_DATASET_ID);
                break;
            case CMD_DATASET_MLM007_DATASET:
                lastProduct = MLM007_DATASET_ID;
                switchDatasetAsap(MLM007_DATASET_ID);
                break;
